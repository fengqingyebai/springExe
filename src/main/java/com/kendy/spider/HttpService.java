...
public class HttpService {
   ...
   * @return
   */
  public HttpResult get(String url, Map<String, String> headers, HttpContext context,
  ...
  public HttpResult postWithMap(String url, Map<String, String> params)
      throws URISyntaxException, IOException {
   ...
   * @throws IOException
   */
  public HttpResult post(String url, String body, Charset charSet, Map<String, String> headers,
   ...
   * @throws URISyntaxException
   */
  private HttpResult request(String method, String url, String body, Charset charSet,
    ...
    try {
      ...
      log.debug("cost=" + (System.currentTimeMillis() - t) + "ms, code=" + result.getStatusCode()
  ...
  private HttpResult requestWithMap(String method, String url, Map<String, String> params,
      String charSet, Map<String, String> headers, HttpContext context, RequestConfig config)
      throws URISyntaxException, IOException {
    CloseableHttpResponse response = null;
    HttpResult result = new HttpResult();
    try {
