...
public class WanjiaApplyInfo {
  ...
  public static void main(String... strings) {
    String json =
        "{\"showId\":\"71258550\",\"strNick\":\"leon668\",\"strSmallCover\":\"http://info.pokermate.net/data/2018/2/4/39101_1517736974551.png\",\"gameRoomId\":28288654,\"gameRoomName\":\"🏧510-122\",\"buyStack\":1000,\"uuid\":39101,\"totalBuyin\":3500,\"totalProfit\":-83}";
    // json = "{}";
  ...
  public String toString() {
    return "WanjiaApplyInfo [showId=" + showId + ", strNick=" + strNick + ", strSmallCover="
        + strSmallCover + ", gameRoomId=" + gameRoomId + ", gameRoomName=" + gameRoomName
