...
public class ProxyTeamInfo implements Entity {
  ...
  public String toString() {
    return "ProxyTeamInfo [proxyTeamId=" + proxyTeamId.get() + ", proxyPlayerId=" + proxyPlayerId
        .get() + ", proxyPlayerName="
        + proxyPlayerName.get() + ", proxyYSZJ=" + proxyYSZJ.get() + ", proxyZJ=" + proxyZJ.get()
        + ", proxyHuishui="
        + proxyHuishui.get() + ", proxyHuiBao=" + proxyHuiBao.get() + ", proxyTableId="
        + proxyTableId.get() +
