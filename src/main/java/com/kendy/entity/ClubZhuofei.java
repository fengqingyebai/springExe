...
public class ClubZhuofei {
   ...
   * @param gudong
   */
  public ClubZhuofei(String time, String clubId, String zhuofei, String lmType, String clubName,
      String gudong) {
    super();
    this.time = time;
    this.clubId = clubId;
  ...
  public String toString() {
    return "ClubZhuofei [time=" + time + ", clubId=" + clubId + ", zhuofei=" + zhuofei + ", lmType="
        + lmType
