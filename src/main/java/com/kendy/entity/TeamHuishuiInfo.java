...
public class TeamHuishuiInfo {
  ...
  public TeamHuishuiInfo(String tuan, String wanjiaId, String wanjia, String shishou,
      String baoxian,
      String chuHuishui, String tableId, String zj, String huibao, String shouHuishui,
      String updateTime) {
    super();
    this.tuan = tuan;
