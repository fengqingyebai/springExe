...
public class ExportExcelTemplate  {
	 ...
	 * @param out
	 */
	public ExportExcelTemplate(String title, String[] rowName, List<Integer> columnWidths, List<Object[]> dataList,
			String out) {
		super();
		this.title = title;
...
//          String title = Message.getString("manifestIExportTitle");
	      ...
	      String[] rowsName = new String[]{"时间","玩家ID","玩家名称","牌局","申请数量","团队可上码","计算可上码","勾选团队","当天","次日","同意审核","审核结果"};
...
//	          dataList.add(objs);
//	      }
	      List<Integer> columnWidths = Arrays.asList(5000,4000,3000,3000,3000,3000,3000,3000,3000,3000,3000,3500);
