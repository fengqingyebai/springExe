...
public final class JFXButtonTest extends Application {
  ...
  public void start(Stage stage) {
    ...
    button.getStylesheets().add(JFXButtonTest.class.getResource("/css/myCss.css").toExternalForm());
...
//        .add(JFXButtonTest.class.getResource("/css/jfoenix-components.css").toExternalForm());
